...
import { StyleSheet, Text, Image, View, Dimensions, TouchableOpacity, ScrollView, Picker,TextInput} from 'react-native';
...
export default function busLayoutScreen({navigation}) {
    ...
    var single =["0","1","2","3","4","5","6","7"];
    var double =["0","1.1","1.2","2.1","2.2","3.1","3.2","4.1","4.2","5.1","5.2","6.1","6.2","7.1","7.2"];
    var semiSleeper =["0","1.1","1.2","1.3","1.4","2.5","2.6","2.7","2.8",
    ...
    <View style={styles.container}>
        <View style={{width: width,height: height,justifyContent:"center",}}>
            ...
            colors={['#fff', '#e6ffe6', '#ccffcc']} style={{width: width,height: height,justifyContent: 'center'}}>
                <ScrollView >
                    <Text style={styles.tittle}>Pricing</Text>
                    ...
                    <Text style={{...styles.tittle,marginTop:5,fontSize:20}}>Lower Birth</Text>

                    <Text style={{...styles.tittle,marginTop:5,fontSize:10}}>Single Side</Text>
                    ...
                    <Text style={{...styles.tittle,marginTop:5,fontSize:10}}>Double Side</Text>
                    ...
                    <View style={{flexDirection:"row",justifyContent:"space-evenly",marginBottom:20,alignContent:"center"}}>
                        <View style={{...styles.picker,elevation: PickerValue <=""? 0.6 :5}}>
                                <Picker
                                    style={{color: '#a6a6a6'}}
                                    mode="dialog"
                                    selectedValue= {g}
                                    onValueChange= {g => setG(g)}>
                                    {double.map((item, index) => {
                                        return (<Picker.Item label={item} value={index} key={index}/>) 
                                    })}
                                </Picker>
                    ...
                    <Text style={{...styles.tittle,marginTop:5,fontSize:10}}>Double Side (Semi-Sleeper)</Text>
                    ...
                    <View style={{flexDirection:"row",justifyContent:"space-evenly",marginBottom:20}}>
                        <View style={{...styles.picker,elevation: PickerValue <=""? 0.6 :5}}>
                                <Picker
                                    ...
                                    mode="dialog"
                                    selectedValue= {i}
                                    onValueChange= {i => setI(i)}>
                                    {semiSleeper.map((item, index) => {
                                        return (<Picker.Item label={item} value={index} key={index}/>) 
                                    })}
                                </Picker>
                        </View>
                    ...
                    <Text style={{...styles.tittle,marginTop:5,fontSize:20}}>Upper Birth</Text>
                    ...
                    <View style={{alignSelf:"flex-end",marginRight:30, marginTop: 20,paddingBottom:width/ 5}}>
